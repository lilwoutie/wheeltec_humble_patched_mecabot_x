...
def generate_launch_description():
    ...
    base_to_link = launch_ros.actions.Node(
            ...
            name='base_to_link',
            arguments=['0', '0', '0.03802','0', '0','0','base_footprint','base_link'],
    )# RT: student Wout heeft op bovenstaande lijn z-axis transform parameter van 0 naar 0.03802 gezet.
    ...
    flagship_type = IncludeLaunchDescription(
            ...
            launch_arguments={'top_mec_dl': 'true'}.items(),
    )
    
    ld = LaunchDescription()

#put minibot into comments, uncommented flagship_type
