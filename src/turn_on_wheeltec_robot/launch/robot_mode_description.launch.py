...
def generate_launch_description():
    ...
    top_mec_bs = LaunchConfiguration('top_mec_bs', default='false')
    	#top_mec_dl set from false to true.
    top_mec_dl = LaunchConfiguration('top_mec_dl', default='true')
    ...
    top_mec_dl_ = GroupAction(
        condition=IfCondition(top_mec_dl),  #RT: er stond blijkbaar IfCondition(top_mec_ds) dit werd door student Wout gewijzigd naar top_mec_dl
        actions=[
        generate_robot_node('top_mec_dl_robot.urdf','top_mec_dl'),
        generate_static_transform_publisher_node(['0.14499 ', '0.00002', '0.18652'], ['0', '0', '0'], 'base_footprint', 'laser'), #RT: Wout, ik denk dat er geen meerwaarde is om hiervan laser_link van te maken want dan moet je dat op meerdere plaatsen gaan vervangen. Heb dit terug gezet naar 'laser'.
